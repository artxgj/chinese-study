...
Search [mdbg](https://www.mdbg.net/chinese/dictionary?page=worddict&wdrst=0&wdqb=POSIX) for definition

Search [wiktionary](https://en.wiktionary.org/wiki/POSIX) for definition

### Tweets containing POSIX
...
##### Other Words/Names of Interest in the Above Tweet
[代码](代码.md), [函数](函数.md), [遗憾](遗憾.md), [重叠](重叠.md)
