...
##### Other Words/Names of Interest in the Above Tweet
[传统](传统.md), [型](型.md), [增长](增长.md), [大幅](大幅.md), [推理](推理.md), [支出](支出.md), [放缓](放缓.md), [数据](数据.md), [模型](模型.md), [芯片](芯片.md), [语言模型](语言模型.md), [需求](需求.md)
___
...
##### Other Words/Names of Interest in the Above Tweet
[OpenAI](OpenAI.md), [人工](人工.md), [人工智能](人工智能.md), [发布](发布.md), [型](型.md), [执行](执行.md), [模型](模型.md), [用于](用于.md), [语言模型](语言模型.md), [降低](降低.md), [预期](预期.md), [首席执行官](首席执行官.md)
___
