...
##### Other Words/Names of Interest in the Above Tweet
[Anthropic](Anthropic.md), [Kimi](Kimi.md), [发布](发布.md), [垄断](垄断.md), [封锁](封锁.md), [打击](打击.md), [执行](执行.md), [控制](控制.md), [机构](机构.md), [模型](模型.md), [硅](硅.md), [硅谷](硅谷.md), [芯片](芯片.md), [蒸馏](蒸馏.md), [首席执行官](首席执行官.md), [黄仁勋](黄仁勋.md)
___
