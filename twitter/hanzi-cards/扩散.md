...
##### Other Words/Names of Interest in the Above Tweet
[NAND](NAND.md), [SK海力士](SK海力士.md), [三星](三星.md), [严重](严重.md), [半导体](半导体.md), [存储](存储.md), [存储器](存储器.md), [掀起](掀起.md), [推迟](推迟.md), [提高](提高.md), [日本](日本.md), [状况](状况.md), [芯片](芯片.md), [行情](行情.md), [铠侠](铠侠.md), [领域](领域.md)
___
