...
Search [mdbg](https://www.mdbg.net/chinese/dictionary?page=worddict&wdrst=0&wdqb=钒) for definition

Search [wiktionary](https://en.wiktionary.org/wiki/钒) for definition
...
[主导](主导.md), [包括](包括.md), [存储](存储.md), [技术](技术.md), [方案](方案.md), [氢](氢.md), [火山](火山.md), [电池](电池.md), [离子](离子.md), [锂](锂.md)
